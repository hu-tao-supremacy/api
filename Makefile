...
generate-local:
	@cd $(dirname $0)
	bazel build //:go --spawn_strategy=local
	bazel build //:python --spawn_strategy=local
	bazel build //:java --spawn_strategy=local
	bazel build //:nest --spawn_strategy=local
	bazel build //:gql --spawn_strategy=local
