...
_ACCESSTOKENPAYLOAD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='email', full_name='hts.account.AccessTokenPayload.email', index=1,
