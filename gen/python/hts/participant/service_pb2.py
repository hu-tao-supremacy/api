...
_PARTICIPANTSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='hts.participant.ParticipantService.GetEventsByName',
    index=9,
    containing_service=None,
