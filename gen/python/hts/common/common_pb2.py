...
_USER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='academicYear', full_name='hts.common.User.academicYear', index=15,
...
_USER.fields_by_name['academicYear'].message_type = google_dot_protobuf_dot_wrappers__pb2._INT32VALUE
