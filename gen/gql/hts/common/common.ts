...
export const Event = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.eventLocationId = Int64Value.decode(
            reader,
            reader.uint32()
          ).value;
          break;
        ...
        case 5:
          ...
          break;
        case 6:
          message.coverImage = StringValue.decode(
            reader,
            reader.uint32()
          ).value;
          break;
        case 7:
          ...
          break;
        case 8:
          message.posterImage = StringValue.decode(
            reader,
            reader.uint32()
          ).value;
          break;
  ...
  fromJSON(object: any): Event {
    ...
    if (
      ...
      message.eventLocationId = Number(object.eventLocationId);
    } else {
    ...
    if (object.posterImage !== undefined && object.posterImage !== null) {
      message.posterImage = String(object.posterImage);
    } else {
  ...
  fromPartial(object: DeepPartial<Event>): Event {
    ...
    if (
      ...
      message.eventLocationId = object.eventLocationId;
    } else {
      message.eventLocationId = undefined;
    }
    if (object.description !== undefined && object.description !== null) {
    ...
    if (object.posterImage !== undefined && object.posterImage !== null) {
      message.posterImage = object.posterImage;
    } else {
      message.posterImage = undefined;
    }
    if (
