...
public final class ParticipantServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<app.onepass.apis.GetOnlineEventsRequest,
      app.onepass.apis.EventsResponse> getGetOnlineEventsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetOnlineEvents",
      requestType = app.onepass.apis.GetOnlineEventsRequest.class,
      responseType = app.onepass.apis.EventsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<app.onepass.apis.GetOnlineEventsRequest,
      app.onepass.apis.EventsResponse> getGetOnlineEventsMethod() {
    io.grpc.MethodDescriptor<app.onepass.apis.GetOnlineEventsRequest, app.onepass.apis.EventsResponse> getGetOnlineEventsMethod;
      ...
      synchronized (ParticipantServiceGrpc.class) {
        if ((getGetOnlineEventsMethod = ParticipantServiceGrpc.getGetOnlineEventsMethod) == null) {
          ParticipantServiceGrpc.getGetOnlineEventsMethod = getGetOnlineEventsMethod =
              io.grpc.MethodDescriptor.<app.onepass.apis.GetOnlineEventsRequest, app.onepass.apis.EventsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetOnlineEvents"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  app.onepass.apis.GetOnlineEventsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  app.onepass.apis.EventsResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<app.onepass.apis.GetOnSiteEventsRequest,
      app.onepass.apis.EventsResponse> getGetOnSiteEventsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetOnSiteEvents",
      requestType = app.onepass.apis.GetOnSiteEventsRequest.class,
      responseType = app.onepass.apis.EventsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<app.onepass.apis.GetOnSiteEventsRequest,
      app.onepass.apis.EventsResponse> getGetOnSiteEventsMethod() {
    io.grpc.MethodDescriptor<app.onepass.apis.GetOnSiteEventsRequest, app.onepass.apis.EventsResponse> getGetOnSiteEventsMethod;
    if ((getGetOnSiteEventsMethod = ParticipantServiceGrpc.getGetOnSiteEventsMethod) == null) {
      synchronized (ParticipantServiceGrpc.class) {
        if ((getGetOnSiteEventsMethod = ParticipantServiceGrpc.getGetOnSiteEventsMethod) == null) {
          ParticipantServiceGrpc.getGetOnSiteEventsMethod = getGetOnSiteEventsMethod =
              io.grpc.MethodDescriptor.<app.onepass.apis.GetOnSiteEventsRequest, app.onepass.apis.EventsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetOnSiteEvents"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  app.onepass.apis.GetOnSiteEventsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  app.onepass.apis.EventsResponse.getDefaultInstance()))
              .setSchemaDescriptor(new ParticipantServiceMethodDescriptorSupplier("GetOnSiteEvents"))
              .build();
        }
      }
    }
    return getGetOnSiteEventsMethod;
  }
  ...
  private static volatile io.grpc.MethodDescriptor<app.onepass.apis.GetObjectByIdRequest,
      app.onepass.apis.Question> getGetQuestionByIdMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetQuestionById",
      requestType = app.onepass.apis.GetObjectByIdRequest.class,
      responseType = app.onepass.apis.Question.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<app.onepass.apis.GetObjectByIdRequest,
      app.onepass.apis.Question> getGetQuestionByIdMethod() {
    io.grpc.MethodDescriptor<app.onepass.apis.GetObjectByIdRequest, app.onepass.apis.Question> getGetQuestionByIdMethod;
    if ((getGetQuestionByIdMethod = ParticipantServiceGrpc.getGetQuestionByIdMethod) == null) {
      synchronized (ParticipantServiceGrpc.class) {
        if ((getGetQuestionByIdMethod = ParticipantServiceGrpc.getGetQuestionByIdMethod) == null) {
          ParticipantServiceGrpc.getGetQuestionByIdMethod = getGetQuestionByIdMethod =
              io.grpc.MethodDescriptor.<app.onepass.apis.GetObjectByIdRequest, app.onepass.apis.Question>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setSchemaDescriptor(new ParticipantServiceMethodDescriptorSupplier("GetQuestionById"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<app.onepass.apis.GetPastEventsFromTagsRequest,
      app.onepass.apis.EventsResponse> getGetPastEventsFromTagsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetPastEventsFromTags",
      requestType = app.onepass.apis.GetPastEventsFromTagsRequest.class,
      responseType = app.onepass.apis.EventsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<app.onepass.apis.GetPastEventsFromTagsRequest,
      app.onepass.apis.EventsResponse> getGetPastEventsFromTagsMethod() {
    io.grpc.MethodDescriptor<app.onepass.apis.GetPastEventsFromTagsRequest, app.onepass.apis.EventsResponse> getGetPastEventsFromTagsMethod;
    if ((getGetPastEventsFromTagsMethod = ParticipantServiceGrpc.getGetPastEventsFromTagsMethod) == null) {
      synchronized (ParticipantServiceGrpc.class) {
        if ((getGetPastEventsFromTagsMethod = ParticipantServiceGrpc.getGetPastEventsFromTagsMethod) == null) {
          ParticipantServiceGrpc.getGetPastEventsFromTagsMethod = getGetPastEventsFromTagsMethod =
              io.grpc.MethodDescriptor.<app.onepass.apis.GetPastEventsFromTagsRequest, app.onepass.apis.EventsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetPastEventsFromTags"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  app.onepass.apis.GetPastEventsFromTagsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  app.onepass.apis.EventsResponse.getDefaultInstance()))
              .setSchemaDescriptor(new ParticipantServiceMethodDescriptorSupplier("GetPastEventsFromTags"))
              .build();
        }
      }
    }
    return getGetPastEventsFromTagsMethod;
  }
  ...
  public static abstract class ParticipantServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getOnlineEvents(app.onepass.apis.GetOnlineEventsRequest request,
        io.grpc.stub.StreamObserver<app.onepass.apis.EventsResponse> responseObserver) {
    ...
    /**
     */
    public void getOnSiteEvents(app.onepass.apis.GetOnSiteEventsRequest request,
        io.grpc.stub.StreamObserver<app.onepass.apis.EventsResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetOnSiteEventsMethod(), responseObserver);
    }
    ...
    /**
     */
    public void getQuestionById(app.onepass.apis.GetObjectByIdRequest request,
        io.grpc.stub.StreamObserver<app.onepass.apis.Question> responseObserver) {
    ...
    /**
     */
    public void getPastEventsFromTags(app.onepass.apis.GetPastEventsFromTagsRequest request,
        io.grpc.stub.StreamObserver<app.onepass.apis.EventsResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetPastEventsFromTagsMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                app.onepass.apis.GetOnlineEventsRequest,
                app.onepass.apis.EventsResponse>(
                  this, METHODID_GET_ONLINE_EVENTS)))
          .addMethod(
            getGetOnSiteEventsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                app.onepass.apis.GetOnSiteEventsRequest,
                app.onepass.apis.EventsResponse>(
                  this, METHODID_GET_ON_SITE_EVENTS)))
          .addMethod(
          ...
          .addMethod(
            getGetPastEventsFromTagsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                app.onepass.apis.GetPastEventsFromTagsRequest,
                app.onepass.apis.EventsResponse>(
                  this, METHODID_GET_PAST_EVENTS_FROM_TAGS)))
          .addMethod(
  ...
  public static final class ParticipantServiceStub extends io.grpc.stub.AbstractAsyncStub<ParticipantServiceStub> {
    ...
    public void getOnSiteEvents(app.onepass.apis.GetOnSiteEventsRequest request,
        io.grpc.stub.StreamObserver<app.onepass.apis.EventsResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGetOnSiteEventsMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void getPastEventsFromTags(app.onepass.apis.GetPastEventsFromTagsRequest request,
        io.grpc.stub.StreamObserver<app.onepass.apis.EventsResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGetPastEventsFromTagsMethod(), getCallOptions()), request, responseObserver);
    }
  ...
  public static final class ParticipantServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ParticipantServiceBlockingStub> {
    ...
    /**
     */
    public app.onepass.apis.EventsResponse getOnlineEvents(app.onepass.apis.GetOnlineEventsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public app.onepass.apis.EventsResponse getOnSiteEvents(app.onepass.apis.GetOnSiteEventsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getGetOnSiteEventsMethod(), getCallOptions(), request);
    }
    ...
    /**
     */
    public app.onepass.apis.Question getQuestionById(app.onepass.apis.GetObjectByIdRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public app.onepass.apis.EventsResponse getPastEventsFromTags(app.onepass.apis.GetPastEventsFromTagsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getGetPastEventsFromTagsMethod(), getCallOptions(), request);
    }
  ...
  public static final class ParticipantServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ParticipantServiceFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<app.onepass.apis.EventsResponse> getOnlineEvents(
        app.onepass.apis.GetOnlineEventsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<app.onepass.apis.EventsResponse> getOnSiteEvents(
        app.onepass.apis.GetOnSiteEventsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getGetOnSiteEventsMethod(), getCallOptions()), request);
    }
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<app.onepass.apis.Question> getQuestionById(
        app.onepass.apis.GetObjectByIdRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<app.onepass.apis.EventsResponse> getPastEventsFromTags(
        app.onepass.apis.GetPastEventsFromTagsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getGetPastEventsFromTagsMethod(), getCallOptions()), request);
    }
  ...
  private static final int METHODID_GET_ON_SITE_EVENTS = 11;
  private static final int METHODID_GET_EVENTS_BY_STRING_OF_NAME = 12;
  private static final int METHODID_GET_EVENTS_BY_TAG_IDS = 13;
  private static final int METHODID_GET_EVENTS_BY_ORGANIZATION_ID = 14;
  private static final int METHODID_GET_EVENTS_BY_FACILITY_ID = 15;
  private static final int METHODID_GET_EVENTS_BY_DATE = 16;
  private static final int METHODID_GET_LOCATION_BY_ID = 17;
  private static final int METHODID_GET_TAGS_BY_EVENT_ID = 18;
  private static final int METHODID_GET_RATING_BY_EVENT_ID = 19;
  private static final int METHODID_GET_USERS_BY_EVENT_ID = 20;
  private static final int METHODID_GET_EVENT_DURATIONS_BY_EVENT_ID = 21;
  private static final int METHODID_GET_QUESTION_GROUPS_BY_EVENT_ID = 22;
  private static final int METHODID_GET_QUESTIONS_BY_QUESTION_GROUP_ID = 23;
  private static final int METHODID_GET_ANSWERS_BY_QUESTION_ID = 24;
  private static final int METHODID_GET_ANSWERS_BY_USER_EVENT_ID = 25;
  private static final int METHODID_GET_USER_ANSWER_BY_QUESTION_ID = 26;
  private static final int METHODID_GET_QUESTION_BY_ID = 27;
  private static final int METHODID_GET_EVENTS_BY_USER_ID = 28;
  private static final int METHODID_GET_USER_EVENT_BY_USER_AND_EVENT_ID = 29;
  private static final int METHODID_GET_USER_EVENTS_BY_EVENT_ID = 30;
  private static final int METHODID_GET_PAST_EVENTS_FROM_TAGS = 31;
  private static final int METHODID_SET_RATING_BY_USER_EVENT_ID = 32;
  private static final int METHODID_GENERATE_QR = 33;
  private static final int METHODID_PING = 34;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_GET_ONLINE_EVENTS:
          serviceImpl.getOnlineEvents((app.onepass.apis.GetOnlineEventsRequest) request,
              (io.grpc.stub.StreamObserver<app.onepass.apis.EventsResponse>) responseObserver);
          break;
        case METHODID_GET_ON_SITE_EVENTS:
          serviceImpl.getOnSiteEvents((app.onepass.apis.GetOnSiteEventsRequest) request,
              (io.grpc.stub.StreamObserver<app.onepass.apis.EventsResponse>) responseObserver);
          break;
        ...
        case METHODID_GET_QUESTION_BY_ID:
          serviceImpl.getQuestionById((app.onepass.apis.GetObjectByIdRequest) request,
              (io.grpc.stub.StreamObserver<app.onepass.apis.Question>) responseObserver);
          break;
        ...
        case METHODID_GET_USER_EVENTS_BY_EVENT_ID:
          serviceImpl.getUserEventsByEventId((app.onepass.apis.GetObjectByIdRequest) request,
              (io.grpc.stub.StreamObserver<app.onepass.apis.GetUserEventsByEventIdResponse>) responseObserver);
          break;
        case METHODID_GET_PAST_EVENTS_FROM_TAGS:
          serviceImpl.getPastEventsFromTags((app.onepass.apis.GetPastEventsFromTagsRequest) request,
              (io.grpc.stub.StreamObserver<app.onepass.apis.EventsResponse>) responseObserver);
          break;
      ...
      synchronized (ParticipantServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getGetOnSiteEventsMethod())
              ...
              .addMethod(getGetPastEventsFromTagsMethod())
